// Daily Calorie Calculator Script
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Result elements
    const maintenanceCalories = document.getElementById('maintenance-calories');
    const mildLossCalories = document.getElementById('mild-loss-calories');
    const lossCalories = document.getElementById('loss-calories');
    const mildGainCalories = document.getElementById('mild-gain-calories');
    ...
    calculateBtn.addEventListener('click', function() {
        ...
        // 1 kg fat ≈ 7700 calories, so 0.25 kg/week = 1925 cal/week ≈ 275 cal/day
        // 0.5 kg/week = 3850 cal/week ≈ 550 cal/day
        const mildLoss = tdee - 275;
        const loss = tdee - 550;
        const mildGain = tdee + 275;
        const gain = tdee + 550;

        // Display results
        maintenanceCalories.textContent = Math.round(tdee);
        mildLossCalories.textContent = Math.round(mildLoss);
        lossCalories.textContent = Math.round(loss);
        mildGainCalories.textContent = Math.round(mildGain);
        gainCalories.textContent = Math.round(gain);

        resultsContainer.style.display = 'block';
        showStatus('Calorie needs calculated successfully!', 'success');
                    ...
                    <div class="tools-footer">
                        <div class="tools-nav">
                            ...
                            <div class="tools-grid">
                                ...
                                <a href="/TOOLS/Calorie-Calculator/" class="tool-card active">
                                    <div class="tool-icon">🍎</div>
