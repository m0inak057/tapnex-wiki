document.addEventListener('DOMContentLoaded', function() {
    ...
    /**
     * Encode the input text using encodeURIComponent
     */
    encodeBtn.addEventListener('click', function() {
        ...
        try {
            ...
            textOutput.value = 'Error: Unable to encode the input';
            console.error('Encoding error:', error);
        }
    });

    /**
     * Decode the input text using decodeURIComponent
     */
    decodeBtn.addEventListener('click', function() {
        ...
        try {
            ...
            textOutput.value = 'Error: Invalid encoded string. Unable to decode.';
